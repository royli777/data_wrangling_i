...
``` r
#selecting and renaming in the same time
...
``` r
#everything() means keeping everything else
...
``` r
#gd0_weight comes first and everything else stays the same
...
``` r
#give you a vector floating around
#???
```
